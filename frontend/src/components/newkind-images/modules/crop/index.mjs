...
index['func'] = {}
index['watch'] = {}
index['this']['originImgSize'] = ''

index['func']['getCoord'] = function (l, t, w, h, obj) {
  l = obj.scale * l
  t = obj.scale * t
  w = obj.scale * w
  h = obj.scale * h
...
index['func']['c-crop--area'] = function (obj, dom) {
...
index['func']['c-crop--cut'] = function (obj, dom) {
...
index['func']['c-preview'] = function (obj, dom) {
...
index['func']['updateSize'] = function (obj, dom) {
  ...
  let coord = {}
  coord = index['func']['getCoord'](obj.left, obj.top, obj.elWidth, obj.elHeight, obj)

  obj['previewImgSize'] = index['func']['setPreview'](coord, obj)
...
index['func']['cut'] = function (obj, dom) {
...
index['func']['setPreview'] = function (coord, obj) {
...
index['func']['setImage'] = function (obj, img) {
...
index['func']['getSize'] = function (obj) {
  return new Promise(resolve => {
    ...
    if (obj['crop']['this']['cropUrl'] && img) {
      img.onload = function () {
        const size = index['func']['getSizeImg'](img)
...
index['func']['setSize'] = async function (obj) {
  if (!obj['upload']['url']) {
    return false
  }
  let imgSize = await index['func']['getSize'](obj)
  obj['crop']['this']['originImgSize'] = imgSize
  obj['crop']['watch']['originImgSize'] = imgSize
  obj = await index['func']['setCoordRange'](obj)
...
index['func']['getSizeImg'] = function (img) {
...
index['func']['setCoordRange'] = function (obj) {
...
index['func']['getCropJson'] = function (obj) {
  return new Promise(function (resolve, reject) {
...
index['func']['openCrop'] = function (event) {
  return new Promise(function (resolve, reject) {
    let _this = this
...
index['func']['dragFn'] = function (event) {
  return new Promise(function (resolve, reject) {
...
index['func']['showImage'] = function (event, cb) {
  return new Promise(function (resolve, reject) {
...
index['func']['setPreviewSize'] = function (obj) {
  return new Promise(function (resolve, reject) {
    ...
    index['watch']['c-preview'](obj['crop']['this'], obj['this'])

    obj['crop']['watch']['end'] = true
    resolve(obj)
  })
}
export default { crop: index }
